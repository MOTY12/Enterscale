...
describe('checkin', () => {
  ...
  it('user should be able to checkin', (done) => {

    // name, email, company, phoneNo, visitingPurpose 
    const visitor = {
      name: 'teejohn247',
      email: 'teejohn247@gmail.com',
      company: 'Aceall',
      phoneNo: '+2348161582774',
      visitingPurpose: 'Business',
      visitingDate: '27/10/2023'
    };
    chai.request(app)
      .post('/api/v1/createVisitor')
      .send(visitor)
      .end((err, res) => {
  ...
  it('should be able to check if a visitor has been prebooked or not', (done) => {
  ...
  it('visitor should not be able to check-in if a visitor has not been prebooked or not', (done) => {

    // name, email, company, phoneNo, visitingPurpose 
    const visitor = {
      phoneNo: '+2348085362264',
    };
    chai.request(app)
      .post('/api/v1/checkNumber')
      .send(visitor)
